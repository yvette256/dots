...
- Misc scripts: [xcwd](https://github.com/schischi/xcwd), [i3lock-fancy](https://github.com/meskarune/i3lock-fancy) + [i3lock-color](https://github.com/PandorasFox/i3lock-color), [zathura](https://www.archlinux.org/packages/community/x86_64/zathura/) + [fzf](https://github.com/junegunn/fzf).
